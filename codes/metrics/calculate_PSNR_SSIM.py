...
def main():
    ...
    folder_GT = '/mnt/data/zhoubo/dataset/Set5/HR'
    folder_Gen = '/mnt/data/zhoubo/train_SR/EDSR-LOSS/experiment/Final_X4_CARes_hf/results-Set5'

    crop_border = 4
    suffix = '_x4_'  # suffix for Gen images
