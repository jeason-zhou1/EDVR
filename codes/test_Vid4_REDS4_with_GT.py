...
def main():
    ...
    if data_mode == 'Vid4':
        if stage == 1:
            model_path = '../../../VSR/EDVR/experiments/pretrained_models/EDVR_Vimeo90K_SR_L.pth'
        else:
    ...
    #### dataset
    if data_mode == 'Vid4':
        test_dataset_folder = '../../../dataset/REDS/sharp_bicubic'
        GT_dataset_folder = '../../../dataset/REDS/GT'
    else:
        if stage == 1:
