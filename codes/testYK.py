...
def main():
    ...
    if data_mode == 'Vid4':
        if stage == 1:
            model_path = '../experiments/pretrained_models/YK9e4.pth'
        else:
    ...
    if stage == 2:
        HR_in = True
        back_RBs = 20
    model = EDVR_arch.EDVR(64, N_in, 8, 5, 10, predeblur=predeblur, HR_in=HR_in)

    #### dataset
    if data_mode == 'Vid4':
        test_dataset_folder = '/mnt/data/zhoubo/dataset/Vid4/BIx4'
        GT_dataset_folder = '/mnt/data/zhoubo/dataset/Vid4/GT'
        test_dataset_folder = '/mnt/data/zhoubo/videodataset/PIC/TestLR'
