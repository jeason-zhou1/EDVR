...
def main():
    ...
    #### create train and val dataloader,mode的类型在数据的加载中起作用
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            # print(model.get_current_learning_rate()[0],model.get_current_learning_rate()[1])
            # for i in model.get_current_learning_rate():
            #     print('current learning rate:{:.3e}'.format(i))
